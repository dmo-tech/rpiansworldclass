    ...
    <form onSubmit={handleSubmit} className="mt-10">
      <div className="grid gap-5 md:grid-cols-2">
        <div>
          ...
          <input
            ...
            autoComplete="name"
            className="w-full rounded-xl border border-white/10 bg-black px-4 py-4 text-white outline-none transition placeholder:text-gray-600 focus:border-[#d9a441]"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl border border-white/10 bg-black px-4 py-4 text-white outline-none transition focus:border-[#d9a441]"
          >
      ...
      <div className="mt-5">
        ...
        <textarea
          ...
          rows={4}
          className="w-full resize-none rounded-xl border border-white/10 bg-black px-4 py-4 text-white outline-none transition placeholder:text-gray-600 focus:border-[#d9a441]"
        />
      </div>
      ...
      <motion.button
        ...
        className="mt-6 w-full rounded-xl bg-gradient-to-r from-[#b67b20] via-[#f1c363] to-[#bd8126] px-7 py-4 text-base font-bold text-black shadow-[0_15px_50px_rgba(217,164,65,0.22)] transition disabled:cursor-not-allowed disabled:opacity-60"
      >
        {isSubmitting
